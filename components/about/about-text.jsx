...
const AboutText = () => {
  return (
    <div className="space-y-7">
      ...
      <p>
        My journey into the world of coding began in 2020 when I stumbled upon a
        captivating programming video. I vividly remember the thrill of creating
        my first project, a Python-based tic-tac-toe game. While I&apos;ll admit
        that I leaned heavily on video tutorials at the time (😂), the sense of
        accomplishment I felt was immense. Since then, my fascination with
        coding has persisted, particularly in the realm of frontend development.
      </p>
      <p>
